...
export function resolveAppRoute(pathname: string): AppRoute {
  ...
  if (pathname === '/industry/quality' || pathname.startsWith('/industry/quality/')) return 'industry-quality'
  if (pathname === '/industry/runtime' || pathname.startsWith('/industry/runtime/')) return 'industry-runtime'
  if (pathname === '/industry/operations' || pathname.startsWith('/industry/operations/')) return 'industry-operations'
...
export function routePath(route: AppRoute): string {
  ...
  if (route === 'industry-quality') return '/industry/quality'
  if (route === 'industry-runtime') return '/industry/runtime'
  if (route === 'industry-operations') return '/industry/operations'
