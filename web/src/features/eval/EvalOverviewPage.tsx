...
export function EvalOverviewView({snapshot}:{snapshot:EvalOverviewSnapshot}){
  ...
  return <main className="eval-page" aria-labelledby="eval-overview-title"><div className="eval-eyebrow">Evaluation Workbench · P11</div><div className="eval-heading-row"><div><h1 id="eval-overview-title">Evaluation</h1><p>Specialist labs remain available, and P11 now unifies them into the reviewed 1030-case Benchmark / Release Gate. Formal Gate status remains owned by pi.</p></div><div className="eval-heading-actions"><a className="eval-primary-link" href="/industry/eval/benchmark">Unified Benchmark</a><a className="eval-primary-link" href="/industry/eval/intent">Intent</a><a className="eval-primary-link" href="/industry/eval/playground/retrieval">Retrieval</a><a className="eval-primary-link" href="/industry/eval/mutation">Mutation</a><a className="eval-primary-link" href="/industry/eval/trace">Trace</a><a className="eval-primary-link" href="/industry/eval/rag">RAG</a><a className="eval-primary-link" href="/industry/eval/normalization">Normalization</a><a className="eval-primary-link" href="/industry/eval/entity">Entity</a><a className="eval-primary-link" href="/industry/eval/tool">Tool</a><a className="eval-primary-link" href="/industry/eval/memory">Memory</a><a className="eval-primary-link" href="/industry/eval/multimodal">Multimodal</a><a className="eval-primary-link" href="/industry/eval/agent-loop">Agent Loop</a><a className="eval-primary-link" href="/industry/eval/report">Report</a><a className="eval-primary-link" href="/industry/eval/sandbox">Sandbox</a></div></div>
    <section className="eval-summary-grid" aria-label="Evaluation summary"><article><strong>1030</strong><span>P11 Golden / Hard corpus</span></article><article><strong>13</strong><span>Unified benchmark domains</span></article><article><strong>{snapshot.datasets.length}</strong><span>Intent datasets</span></article><article><strong>{completedRuns.length}</strong><span>Completed intent runs</span></article><article><strong>10</strong><span>Retrieval stages</span></article><article><strong>7</strong><span>Mutation safety gates</span></article><article><strong>6</strong><span>Trace gates</span></article><article><strong>4</strong><span>RAG evidence cases</span></article><article><strong>4</strong><span>P7 specialist labs</span></article><article><strong>6</strong><span>Multimodal safety cases</span></article><article><strong>9</strong><span>Agent Loop safety cases</span></article><article><strong>10</strong><span>Report safety cases</span></article><article><strong>8</strong><span>Sandbox safety cases</span></article></section>
