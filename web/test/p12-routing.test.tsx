...
describe('P12 routing',()=>{
  it('routes Online Quality before the generic industry catch-all',()=>{
    ...
    const html=renderToStaticMarkup(<AppShell initialPath="/industry/quality" onlineQuality={<div>Online Quality sentinel</div>}/>)
    expect(html).toContain('Online Quality sentinel')
