...
describe('RagEvalView', () => {
  ...
  it('renders guarded release gate with no failures', () => {
    ...
    expect(html).toContain('No failed RAG cases')
  })
})
